...
export default class ReservePek extends Component {
    componentDidMount() {
            ...
            <Fragment>
                ...
                <div className="wu_Pek_box">
                    <div className="wu_Pek_box1">
                        ...
                        <p className="wu_Pek_p">北京大学</p>
                        <div className="wu_Pek_line"></div>
                        <p className="wu_Pek_p1"> 此高校需要预约，并仅限于非工作日<br/>
                        参观。您可以点击下方按钮进行预约</p>
                        <p className="wu_Pek_p2">预约方式</p>
                        <button className="wu_Pek_button" onClick={()=>{window.location.href="https://visitor.pku.edu.cn/visitor/modules/tourist/indexW.html#/touristWeb"}}>官网预约</button>
